...
namespace AplicacionLogin.Controllers
{
    public class MotoController : Controller
    {
        ...
        public ActionResult moto_pagina4_1(double calculo, double ton, string nombre, string email, string telefono, string empresa, string pais)
        {
            ViewBag.Title = "Compensación de carbono para Moto";
        ...
        public ActionResult moto_pagina4_2(double calculo, double ton, string nombre, string email, string telefono, string empresa, string pais)
        {
            ViewBag.Title = "Compensación de carbono para Moto";
            ViewBag.total = calculo;
            ViewBag.toneladas = ton;
