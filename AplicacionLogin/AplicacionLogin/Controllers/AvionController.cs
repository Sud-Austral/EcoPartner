...
namespace AplicacionLogin.Controllers
{
    public class AvionController : Controller
    {
        ...
        public ActionResult Avion_pagina2EN()
        {
            int recorrido = ViewBag.recorrido;
            ViewBag.Title = "Compensación de carbono para Avión";
            return View();
        ...
        public ActionResult Avion_pagina3EN(double recorrido, double toneladas, double total, string nombre, string correo)
        {
            ViewBag.Title = "Compensación de carbono para Avión";
            ViewBag.recorrido = recorrido;
            ViewBag.toneladas = toneladas;
        ...
        public ActionResult Avion_pagina4EN(double porsentaje, double total, double ton, string nombre, string correo)
        {
            ViewBag.Title = "Compensación de carbono para Avión";
            CALCULOS ca = new CALCULOS();
            //double totalf = ca.Calculartotalf(porsentaje, total);
        ...
        public ActionResult Avion_pagina4_1EN(double calculo, double ton, string nombre, string telefono, string empresa, string pais, string email)
        {
            ViewBag.Title = "Compensación de carbono para Avión";
            ViewBag.total = calculo;
            ViewBag.toneladas = ton;
            ...
            *********************************************************************************/
            ...
            string returnUrl = "http://localhost:62106/Avion/Retorno_avion";
            string returnFinal = "http://localhost:62106/Avion/Final_avion";
            //string returnUrl = "https://ecopartnerbank.azurewebsites.net/Avion/Retorno_avionEN";
            //string returnFinal = "https://ecopartnerbank.azurewebsites.net/Avion/Final_avionEN";
        ...
        public ActionResult BuscarAeropuertosEN(string inicio, string destino, int recorrido, int pasajeros, int tipoViaje, string nombre, string correo)
        {
            ViewBag.Title = "Compensación de carbono para Avión";
            AEROPUERTO p1 = new AEROPUERTO();
            AEROPUERTO p2 = new AEROPUERTO();
        ...
        public ActionResult Final_avionEN()
        {
            ViewBag.Title = "Compensación de carbono para Avión";
            ViewBag.Message = "Your contact page.";
            //ViewBag.toneladas = Response.Write Session("toneladas");
        ...
        public ActionResult Retorno_avionEN()
        {
            ViewBag.Title = "Compensación de carbono para Avión";
            //*********************************************************************************
            //                                     Ambiente de producción
