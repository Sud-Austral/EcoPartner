...
namespace AplicacionLogin.Controllers
{
    public class AutoController : Controller
    {
        ...
        public ActionResult auto_pagina4(double porsentaje, double total, double ton, string nombre, string correo, string telefono, string empresa, string pais)
        {
            ViewBag.Title = "Compensación de carbono para Autos";
        ...
        public ActionResult auto_pagina4_1(double calculo, double ton, string nombre, string email, string telefono, string empresa, string pais)
        {
            ViewBag.Title = "Compensación de carbono para Autos";
