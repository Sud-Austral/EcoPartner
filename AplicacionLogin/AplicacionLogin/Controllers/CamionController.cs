...
namespace AplicacionLogin.Controllers
{
    public class CamionController : Controller
    {
        ...
        public ActionResult camion_pagina2EN()
        {
            ViewBag.Title = "Compensación de carbono para Camión";
            return View();
        }
        ...
        public ActionResult camion_pagina3EN(double recorrido, double toneladas, double total, string nombre, string correo)
        {
            ViewBag.Title = "Compensación de carbono para Camión";
            ViewBag.recorrido = recorrido;
            ViewBag.toneladas = toneladas;
        ...
        public ActionResult camion_pagina4EN(double porsentaje, double total, double ton, string nombre, string correo)
        {
            ViewBag.Title = "Compensación de carbono para Camión";
            CALCULOS ca = new CALCULOS();
            //double totalf = ca.Calculartotalf(porsentaje, total);
        ...
        public ActionResult camion_pagina4_1EN(double calculo, double ton, string nombre, string telefono, string empresa, string pais, string email)
        {
            ViewBag.Title = "Compensación de carbono para Camión";
            ViewBag.total = calculo;
            ...
            //string returnUrl = "http://localhost:62106/Camion/Retorno_camion";
            //string returnFinal = "http://localhost:62106/Camion/Final_camion";
            string returnUrl = "https://ecopartnerbank.azurewebsites.net/Camion/Retorno_camionEN";
            string returnFinal = "https://ecopartnerbank.azurewebsites.net/Camion/Final_camionEN";
        ...
        public ActionResult CalculosCamionEN(string kilometros, string toneladasCarga, string nombre, string correo)
        {
            ViewBag.Title = "Compensación de carbono para Camión";
            Double num;
            bool isNum = Double.TryParse(kilometros, out num);
        ...
        public ActionResult Final_camionEN()
        {
            ViewBag.Title = "Compensación de carbono para Camión";
            ViewBag.Message = "Your contact page.";
            //ViewBag.toneladas = Response.Write Session("toneladas");
        ...
        public ActionResult Retorno_camionEN()
        {
            ViewBag.Title = "Compensación de carbono para Camión";
            //*********************************************************************************
            //                                     Ambiente de producción
